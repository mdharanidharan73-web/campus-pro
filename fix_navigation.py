                    ...
                    androidx.navigation.compose.composable("subject/{subjectId}") { backStackEntry ->
                        ...
                        Column(modifier = Modifier.iosSwipeBack(enabled = true, onPop = { navController.popBackStack() })) {
                            SubjectDetailsScreen(
                                ...
                                onNavigateToAssignment = { assignmentId -> navController.navigate("assignment/$assignmentId/$subjectId") },
                                onNavigateToFaculty = { facultyName, subjectCode -> navController.navigate("faculty/$facultyName/$subjectCode") }
                            )
                        }
                    }
                    androidx.navigation.compose.composable("assignment/{assignmentId}/{subjectId}") { backStackEntry ->
